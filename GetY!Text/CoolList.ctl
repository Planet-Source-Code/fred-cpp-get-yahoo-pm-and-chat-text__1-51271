...
Private Sub iScr_Paint()
    ...
    If (Not Ambient.UserMode) Then
        ...
        Select Case m_Alignment
            ...
            Case 1: iScr.CurrentX = (ScaleWidth - iScr.TextWidth(Ambient.DisplayName)) * 0.5
            Case 2: iScr.CurrentX = (ScaleWidth - iScr.TextWidth(Ambient.DisplayName)) - m_ItemOffset
        End Select
    ...
    Else: If (Not m_Resizing) Then DrawList
    End If
End Sub
